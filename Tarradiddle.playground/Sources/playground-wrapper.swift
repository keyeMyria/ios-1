// from https://github.com/kickstarter/ios-oss
// and https://talk.objc.io/episodes/S01E51-playground-driven-development

import UIKit

public let aVeryLongString = """
Lorem ipsum dolor sit amet, consectetur adipiscing elit.
Praesent et nulla porttitor elit fermentum finibus eget id massa.
Nam ac eleifend velit, vel tincidunt massa. Phasellus eget dolor laoreet,
congue metus pharetra, euismod turpis. Donec commodo bibendum velit gravida
dignissim. Vestibulum eleifend sodales ex, at aliquam dolor sagittis ac.
Etiam non lorem suscipit, viverra magna non, sagittis arcu. In ultrices,
nunc ac convallis vestibulum.
"""
...
/**
 ...
 - returns: A root controller that can be set to the playground's live view.
 */
public func playgroundWrapper(
  ...
  child.view.frame.size = parentSize
  child.preferredContentSize = parentSize
